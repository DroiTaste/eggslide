package login.kakao_login_support;
...
import ultra.seed.eggslide.GlobalApplication;
...
public class Kakao_SDK_Adapter extends KakaoAdapter {
    ...
    public IApplicationConfig getApplicationConfig() {
        return new IApplicationConfig() {
            ...
            public Context getApplicationContext() {
                return GlobalApplication.getMainApplicationContext();
            }
        };
    }
}
